...
public static class RateLimitExtensions
    {
        public static IServiceCollection ConfigureRateLimit(this IServiceCollection services,
            Action<RateLimitSetting> options, Core.Logging.ILogger logger)
        {
        ...
        private static void WriteMessage(string message, string methodName, Core.Logging.ILogger _logger)
        {
            _logger.Write(
