...
namespace Framework.Kafka
{
    public interface IKafkaProducer<TKey, TMessage>
    {
        ...
        void Produce(TKey key, TMessage message, Action<DeliveryResult<TKey, TMessage>> action = null, string eventId = null, params KeyValuePair<string, string>[] headers);
        void Produce(TKey key, TMessage message, string topicName, Action<DeliveryResult<TKey, TMessage>> action = null, string eventId = null, params KeyValuePair<string, string>[] headers);
